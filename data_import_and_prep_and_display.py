...
def getColumnHeader(columnNumber):
    return prepareFile(columnNumber)[0]

def getColumnContent(columnNumber):
    return prepareFile(columnNumber)[1]

def prepareFile(columnNumber):
    ...
    return headList[columnNumber], contentList[columnNumber::7]
